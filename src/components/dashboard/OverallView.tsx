...
export function OverallView() {
  ...
  const profitBeforeAds = avgSalePrice - avgFees - avgCOGS;
  ...
  const profitMargin = totalSales > 0 ? ((totalSales - (avgCOGS * totalUnits) - (avgFees * totalUnits) - ppcSpend) / totalSales) * 100 : 0;
  const netProfit = totalSales - (avgCOGS * totalUnits) - (avgFees * totalUnits) - ppcSpend;
